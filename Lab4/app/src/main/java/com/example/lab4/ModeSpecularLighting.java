...
public class ModeSpecularLighting extends myWorkMode {

    private int startQuad;
    private int countQuad;

    public ModeSpecularLighting() {
        super();
    ...
    public void myCreateShaderProgram() {
        compileAndLinkProgram(myShadersLibrary.VERTEX, myShadersLibrary.FRAG_SPECULAR_NO_ATTEN);
    ...
    public void myUseProgramForDrawing(int width, int height) {
        ...
        GLES32.glUniform3f(uColor, 0.55f, 0.55f, 0.55f);
        setMatrices();
